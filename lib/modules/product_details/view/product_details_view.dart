          ...
          child: Obx(
            () => SingleChildScrollView(
              child: Column(
                ...
                children: [
                  // Gallery outside padded block — takes full available width
                  _ProductGallery(
                    images: images,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _PriceStockCard(
                          ...
                          inStock:
                              (controller.product['inStock'] as bool?) ?? true,
                          deliveryText:
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const SizedBox(height: 12),
        // Thumbnail strip re-padded to match column inset
        Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(20),
                          // Animate bar from 0 → value on first build
                          child: TweenAnimationBuilder<double>(
                            key: ValueKey('bar_$star'),
                            duration:
                                Duration(milliseconds: 500 + (5 - star) * 80),
