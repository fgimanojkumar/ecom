...
import '../widgets/multiImageView/src/image_file.dart';
import '../widgets/multiImageView/src/picker_extension.dart';

Future<List<ImageFile>> pickImagesUsingImagePicker(String action) async {
...
Future<List<ImageFile>> pickImagesUsingCamera(bool allowMultiple) async {
  final picker = ImagePicker();
  final List<XFile> xFiles;
  if (allowMultiple) {
    xFiles = [];
